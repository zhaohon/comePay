...
class UsedCouponTab extends StatefulWidget {
  const UsedCouponTab({super.key});

  @override
  State<UsedCouponTab> createState() => _UsedCouponTabState();
}

class _UsedCouponTabState extends State<UsedCouponTab> {
  ...
  void _onScroll() {
    if (scrollController.position.pixels >=
      ...
      viewModel.loadMoreCoupons('used');
    }
  }
  ...
  Widget build(BuildContext context) {
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            ElevatedButton(
              onPressed: () => viewModel.refreshCoupons('used'),
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            Text(localizations.noUsedCoupons,
                style: TextStyle(fontSize: 16, color: Colors.grey)),
          ],
        ),
      );
    ...
    return RefreshIndicator(
      onRefresh: () => viewModel.refreshCoupons('used'),
            ...
            child: ListTile(
              ...
              subtitle: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 4),
                  Text(
                    '${localizations.used}: ${coupon.usedAt?.toString().split(' ')[0] ?? 'N/A'}',
