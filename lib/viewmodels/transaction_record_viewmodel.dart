...
class TransactionRecordViewModel extends BaseViewModel {
  ...
  Future<void> fetchTransactionRecords(AppLocalizations l10n,
  ...
  List<Map<String, dynamic>> getTransactionDisplayData(AppLocalizations l10n) {
    return _transactionRecords.map((record) {
      ...
      final type = isPositive ? l10n.credit : l10n.debit;
