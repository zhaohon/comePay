...
class GlobalService extends BaseService {
  ...
  Future<SendMessageResponseModel> sendChatMessage(
    ...
    final data = await post(
      'https://app.comecomepay.com/api/chat/send',
      data: request.toJson(),
    );
  ...
  Future<CarddetailResponseModel> initGetCard(int kyc_id) async {
    ...
    final data = await get(
      'https://app.comecomepay.com/api/v1/card',
  ...
  Future<CardResponseModel> getCardData(String userId) async {
    ...
    try {
      final data = await get(
        'https://app.comecomepay.com/api/card',
        options: Options(
  ...
  Future<bool> sendEmail(String email, String name, String otp,
    ...
    try {
      await post(
        'https://app.comecomepay.com/api/v1/auth/verify-otp',
        data: {
          'email': email,
          'referral_code': '',
          'otp_code': otp,
  ...
  Future<dynamic> createWallet(
    ...
    try {
      final data = await post(
        'https://app.comecomepay.com/api/wallet',
        data: request.toJson(),
        options: Options(
          headers: {'id_user': userId},
        ),
  ...
  Future<ChatHistoryResponse> getChatHistory(
    ...
    try {
      final data = await get(
        'https://app.comecomepay.com/api/chat/history/$userId',
        queryParameters: {
          'page': page,
          'limit': limit,
        },
