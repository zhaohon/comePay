...
class KycService extends BaseService {
  ...
  Future<Map<String, dynamic>> getUserKyc(String email) async {
    ...
    final response = await dio.get(endpoint, queryParameters: queryParams, options: Options(headers: {'Authorization': 'Bearer $token'}));
    ...
    if (response.statusCode == 200) {
      ...
      if (data['code'] == 200 && data['data'] != null) {
        ...
        final list = (kycData['list'] as List).map((json) => KycModel.fromJson(json)).toList();
